...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="index3.html" class="nav-link">Welcome,&nbsp;Admin</a>
      </li>
    </ul>
  </nav>
  <!-- /.navbar -->
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      <img src="img/logo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8">
      <span class="brand-text font-weight-light">Lawyer Referral</span>
    </a>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="/newLawyer" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Add Lawyer</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="/viewLawyers" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>View Lawyers</p>
                </a>
              </li>
  ...
  <footer class="main-footer">
    <strong>Copyright &copy;2019 <a href="/">Lawyer Referral</a>.</strong>
    All rights reserved.
